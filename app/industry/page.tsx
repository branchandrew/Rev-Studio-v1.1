...
export default function IndustryPage() {
  ...
  const handleContinue = () => {
    if (selectedIndustry) {
      // Save the selected industry and redirect
  ...
  return (
    <div className="min-h-screen grid grid-cols-12 bg-white">
      ...
      <div className="col-span-10 py-6 md:py-10">
        <div className="w-2/3 max-w-3xl min-h-[793px] relative">
          {/* Logo */}
          <div className="mb-12">
          ...
          {/* Header */}
          <div className="mb-10">
            <h1 className="text-4xl font-bold text-gray-900 mb-4">Welcome to Rev</h1>
            <p className="text-xl text-gray-700 mb-1">
              Choose the option that best describes your industry and we'll personalize your Rev experience.
            </p>
          ...
          >
            <div className="relative">
              <RadioGroupItem value="consulting" id="consulting" className="peer sr-only" />
              <Label
                htmlFor="consulting"
                className="flex h-16 w-full cursor-pointer rounded-md border border-gray-200 p-4 hover:bg-gray-50 peer-data-[state=checked]:border-primary peer-data-[state=checked]:bg-primary/5"
              >
                Consulting
              </Label>
            </div>
            ...
            <div className="relative">
              <RadioGroupItem value="content-creation" id="content-creation" className="peer sr-only" />
              <Label
            ...
            <div className="relative">
              <RadioGroupItem value="research" id="research" className="peer sr-only" />
              <Label
                htmlFor="research"
                className="flex h-16 w-full cursor-pointer rounded-md border border-gray-200 p-4 hover:bg-gray-50 peer-data-[state=checked]:border-primary peer-data-[state=checked]:bg-primary/5"
              >
            ...
            <div className="relative">
              <RadioGroupItem value="technology" id="technology" className="peer sr-only" />
              <Label
                htmlFor="technology"
                className="flex h-16 w-full cursor-pointer rounded-md border border-gray-200 p-4 hover:bg-gray-50 peer-data-[state=checked]:border-primary peer-data-[state=checked]:bg-primary/5"
              >
          ...
          <div className="flex items-center gap-4 absolute bottom-0 left-0">
            ...
            <Button
              ...
              variant={selectedIndustry ? "default" : "secondary"}
              className="w-[375px] py-2 disabled:opacity-50"
            >
              Continue
            </Button>
          </div>
